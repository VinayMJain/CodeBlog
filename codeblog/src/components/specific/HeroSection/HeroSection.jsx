        ...
        <>
            <header>   
                <nav>
                    ...
                    >
                        <Button id="signIneButtonId" buttonText="Sign In"/>
                        <Button id="signUpButtonId" buttonText="Sign Up"/>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        />
                        <svg 
                            className={styles.hexagonClip} 
                            height="0"
                            id="firstSvgElementId"
                            width="0" 
                        >
                            <clipPath 
                                clipPathUnits="objectBoundingBox"
                                id="hexagonClipPathId" 
                            >
